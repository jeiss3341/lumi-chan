...
module.exports = {
  ...
  README: {
    ...
    description: [
      ...
      '',
      '💰 **Requesting a Bounty**',
      '> 1. The **requester** presses **Request Bounty** on the request board and fills out a short form (name, description, reward).',
      ...
      '> 3. Inside the ticket, staff **Approve** (opens an edit modal to adjust wording/reward before it goes live) or **Deny** (closes the ticket).',
