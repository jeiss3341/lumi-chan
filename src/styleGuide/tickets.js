...
function buildTicketDetailHtml({ ticket, messages, mentions, username, message }) {
  ...
  // Message Content intent — see index.js) are already filtered out before
  // this ever sees them (src/styleGuide/ticketRoutes.js fetchTicketDetail).
  const log = messages.length
    ...
    : `<div class="empty-state">No visible messages in this ticket.</div>`;
